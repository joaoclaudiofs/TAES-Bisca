...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('user_customizations')->delete();
        ...
        if (DB::getDriverName() === 'sqlite') {
            ...
            DB::statement("DELETE FROM sqlite_sequence WHERE name = 'notifications'");
            DB::statement("DELETE FROM sqlite_sequence WHERE name = 'user_notifications'");
            DB::statement("DELETE FROM sqlite_sequence WHERE name = 'user_customizations'");
            DB::statement("DELETE FROM sqlite_sequence WHERE name = 'customizations'");
        } else {
            ...
            DB::statement('ALTER TABLE notifications AUTO_INCREMENT = 0');
            DB::statement('ALTER TABLE user_notifications AUTO_INCREMENT = 0');
            DB::statement('ALTER TABLE user_customizations AUTO_INCREMENT = 0');
            DB::statement('ALTER TABLE customizations AUTO_INCREMENT = 0');
        }
        ...
        $this->call(CustomizationsSeeder::class);
