...
class VerifyScoreboardGlobalRankingsUS21 {
	/**
	...
	@When("Eu clico no botão {string} 21")
	...
	@Then("Eu vejo o texto {string} 21")
	def eu_vejo_o_texto(String string) {
		...
		Mobile.tap(findTestObject('Object Repository/android.widget.Button - Coins'), 0)
	}
