...
class VerifyDashboardAccessUS5 {
	/**
	...
	@When("Eu realizo o login {string} ou clico no botão {string} 5")
	def eu_realizo_o_login_ou_clico_no_botao(String string1, String string2) {
		if(string1.equals("1")) {
			println "Login step - Authenticated user"
			...
			Mobile.tap(findTestObject('Object Repository/android.widget.Button - ' + string2), 2)
		}
	}

	@Then("Eu vejo o texto {string} 5")
