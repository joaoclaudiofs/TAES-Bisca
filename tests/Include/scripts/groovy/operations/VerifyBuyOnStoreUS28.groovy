...
class VerifyBuyOnStoreUS28 {
	...
	@When("Eu clico no botão {string} 28")
	def eu_clico_no_botao(String string) {
		Mobile.delay(5)
		Mobile.tap(findTestObject('Object Repository/android.widget.TextView - ' + string), 0)
	}

	@Then("Eu vejo o texto {string} 28")
	...
	@And("Eu clico no botão para comprar {string} 28")
	def eu_clico_no_botao_comprar(String string) {

		TestObject btnIndex9 = new TestObject("btnIndex9")
		btnIndex9.addProperty("class", ConditionType.EQUALS, "android.widget.Button")
		btnIndex9.addProperty("index", ConditionType.EQUALS, "9")

		Mobile.waitForElementPresent(btnIndex9, 10)

		Mobile.tap(btnIndex9, 3)
