...
class VerifyAnonymousRestrictionsUS4 {
	/**
	...
	@Then("Eu verifico que as opções {string}, {string}, {string}, {string} estão bloqueadas 4")
	def eu_verifico_opcoes_bloqueadas(String string1, String string2, String string3, String string4) {
		verificarNaoClicavel(string1)
		verificarNaoClicavel(string2)
		verificarNaoClicavel(string3)
		verificarNaoClicavel(string4)
	}
	...
	def verificarNaoClicavel(String objectName){
		TestObject to = findTestObject('Object Repository/android.view.View - ' + objectName)

		Mobile.verifyElementExist(to, 0)

		Mobile.verifyElementAttributeValue(to, "clickable", "false", 0)
	}
}