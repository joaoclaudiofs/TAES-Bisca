...
class VerifyPersonalAndGlobalScoreUS8 {
	/**
	...
	@When("Eu clico no botão {string} 8")
	...
	@Then("Eu vejo o texto {string} e partidas recentes 8")
	def eu_vejo_o_texto_e_partidas_recentes(String string) {
		Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - ' + string), string)
		Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - ' + "Recent Matches"), "Recent Matches")
	}
