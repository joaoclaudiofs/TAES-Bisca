...
class VerifyGameHistoryAndLeaderboardUS27 {
	/**
	...
	@When("Eu clico no botão {string} 27")
	def eu_clico_no_botao(String string) {
		Mobile.delay(5)
		Mobile.tap(findTestObject('Object Repository/android.widget.TextView - ' + string), 3)
	}

	@And("Eu vejo o texto {string} e volto para a dashboard 27")
	def eu_vejo_o_texto_leaderboard(String string) {
		Mobile.waitForElementPresent(findTestObject('Object Repository/android.widget.TextView - ' + string), 2)
		Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - ' + string), string)
		Mobile.tap(findTestObject('Object Repository/android.widget.Button - Back from Leaderboard'), 2)
	}


	@Then("Eu pressiono o botão {string} 27")
	def eu_pressiono_o_botao(String string) {
		Mobile.waitForElementPresent(findTestObject('Object Repository/android.widget.TextView - ' + string), 2)
		Mobile.tap(findTestObject('Object Repository/android.widget.TextView - ' + string), 3)
	}

	@And("Eu observo o texto {string} 27")
	def eu_observo_o_texto_match(String string) {
