...
class VerifyShowUserInformationUS9 {
	/**
	...
	def eu_estou_na_dashboard() {
		Mobile.verifyElementExist(findTestObject('Object Repository/android.view.View - Dashboard (1)'), 0)
	}

	@Then("Eu vejo o meu nome e foto 9")
	def eu_vejo_o_meu_nome_e_foto() {
