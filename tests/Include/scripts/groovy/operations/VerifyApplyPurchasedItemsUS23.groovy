...
class VerifyApplyPurchasedItemsUS23 {
	/**
	...
	@When("Eu clico no botão {string} 23")
	...
	@Then("Eu vejo o texto {string} e aplico o item {string} 23")
	def eu_vejo_o_texto(String string1, String string2) {
		...
		dynamicButton.addProperty("text", ConditionType.EQUALS, string2)
		Mobile.waitForElementPresent(dynamicButton, 5)
		Mobile.tap(findTestObject('Object Repository/android.widget.Button - ' + string2), 3)
	}
