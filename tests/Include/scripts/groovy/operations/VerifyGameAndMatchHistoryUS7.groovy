...
class VerifyGameAndMatchHistoryUS7 {
	/**
	...
	@When("Eu clico no botão {string} 7")
	...
	def eu_vejo_detalhes() {
		Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - ' + "Match History"), "Match History")

		Mobile.verifyElementExist(findTestObject('Object Repository/android.widget.Button - Details'), 0)

		Mobile.tap(findTestObject('Object Repository/android.widget.Button - Details'), 0)

		Mobile.verifyElementExist(findTestObject('Object Repository/android.widget.TextView - Match Games'), 0)
	}
